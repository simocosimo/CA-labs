...
uint32_t init_mul_timer ( uint8_t timer_num, uint32_t TimerInterval1, uint32_t TimerInterval2 )
{
  if ( timer_num == 0 )
  {
	LPC_TIM0->MR0 = TimerInterval1;
	LPC_TIM2->MR0 = TimerInterval2;
  ...
  {
	LPC_TIM1->MR0 = TimerInterval1;
	LPC_TIM1->MR1 = TimerInterval2;
	LPC_TIM1->MCR = 3;				
